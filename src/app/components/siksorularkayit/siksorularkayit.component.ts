...
@Component({
  selector: 'app-siksorularkayit',
  templateUrl: './siksorularkayit.component.html',
  styleUrls: ['./siksorularkayit.component.css']
})
export class SiksorularkayitComponent implements OnInit {
  kayitlar: any;
